...
let g:which_key_map['C'] = [ ':TagbarToggle'                                            , 'Tagbar' ]
" s is for search
...
let g:which_key_map.D = {
      ...
      \ 'J' : [':CocCommand java.debug.vimspector.start'       , 'Java debug'],
      \ }
...
let g:which_key_map.l = {
      ...
      \ 'I' : [':CocList diagnostics'                , 'diagnstics'],
...
let g:which_key_map.c = {
      ...
      \ 'R' : [':<Plug>(coc-rename)'                               , 'rename'],
      \ 't' : [':<Plug>(coc-type-definition)'                               , 'type definition'],
      \ 'n' : [':<Plug>(coc-declaration)'                               , 'declaration'],
      \ 'i' : [':<Plug>(coc-implementation)'                               , 'implementation'],
      \ 'f' : [':<Plug>(coc-format)'                               , 'format'],
      \ 'q' : [':<Plug>(coc-fix-current)'                               , 'quick fix'],
      \ 'l' : [':<Plug>(coc-codelens-actions)'                               , 'code lens'],
      \ 'j' : [':<Plug>(coc-diagnostic-next)'                               , 'next diagnostic'],
      \ 'k' : [':<Plug>(coc-diagnostic-next-error)'                               , 'next error'],
      \ 'D' : [':CocList diagnostics'                               , 'diagnostics'],
      \ 'o' : [':CocList outline'                               , 'search outline'],
      \ 'I' : [':CocList -I symbols'                               , 'references'],
      \ 'm' : [':CocList marketplace'                               , 'marketplace'],
      \ 'u' : [':CocUpdate'                               , 'update Coc'],
      \ 's' : [':CocDisable'                               , 'disable Coc'],
...
let g:which_key_map.m = {
      \ 'name' : '+media' ,
      \ 'c' : [':CmusCurrent'                           , 'current media'],
      \ 'b' : [':CmusPrevious'                           , 'previous media'],
      \ 'n' : [':CmusNext'                           , 'next media'],
      \ 'p' : [':CmusPlay'                           , 'play media'],
      \ 'h' : [':CmusPause'                           , 'pause media'],
      \ 's' : [':CmusStop'                           , 'stop media'],
      \ }
